      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="card p-8 relative shadow-depth card-hover-lift">
            ...
            <p className="mb-6 relative z-10">I use it during my commute and lunch breaks when coaching appointments don't fit my schedule. It's like having support that adapts to my life.</p>
          ...
          <div className="card p-8 relative shadow-depth card-hover-lift">
            <div className="absolute -top-4 -left-4 text-6xl text-[var(--primary)] opacity-20">"</div>
            <p className="mb-6 relative z-10">Stride helps me apply what I learned in coaching and prevents me from slipping back. It's the perfect complement to my monthly sessions.</p>
            <div className="flex items-center">
